...
const COMPONENT_COLOR_PALETTE = ['0d1b2a', '1b263b', '415a77', '778da9', 'e0e1dd',
'34495e', '2c3e50', '95a5a6', '7f8c8d', 'bdc3c7',
'16a085', '27ae60', '2980b9', '8e44ad', '2c3e91']
...
window.onload = function() {
    ...
    for (let i = 0; i < numIndexes; i++) {
        ...
        const randomColor = COMPONENT_COLOR_PALETTE[randIndex];
        colorIndex.push({
            r: Math.floor(parseInt(randomColor.substring(0, 2), 16)),
            g: Math.floor(parseInt(randomColor.substring(2, 4), 16)),
            b: Math.floor(parseInt(randomColor.substring(4, 6), 16))
        });
    }
